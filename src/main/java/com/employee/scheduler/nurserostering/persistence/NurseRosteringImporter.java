...
package com.employee.scheduler.nurserostering.persistence;
...
import com.employee.scheduler.common.persistence.AbstractXmlSolutionImporter;
import com.employee.scheduler.nurserostering.domain.DayOfWeek;
import com.employee.scheduler.nurserostering.domain.Employee;
import com.employee.scheduler.nurserostering.domain.pattern.FreeBefore2DaysWithAWorkDayPattern;
import com.employee.scheduler.nurserostering.domain.NurseRoster;
import com.employee.scheduler.nurserostering.domain.NurseRosterParametrization;
import com.employee.scheduler.nurserostering.domain.pattern.Pattern;
import com.employee.scheduler.nurserostering.domain.Shift;
import com.employee.scheduler.nurserostering.domain.ShiftAssignment;
import com.employee.scheduler.nurserostering.domain.ShiftDate;
import com.employee.scheduler.nurserostering.domain.ShiftType;
import com.employee.scheduler.nurserostering.domain.pattern.ShiftType2DaysPattern;
import com.employee.scheduler.nurserostering.domain.pattern.ShiftType3DaysPattern;
import com.employee.scheduler.nurserostering.domain.ShiftTypeSkillRequirement;
import com.employee.scheduler.nurserostering.domain.Skill;
import com.employee.scheduler.nurserostering.domain.SkillProficiency;
import com.employee.scheduler.nurserostering.domain.WeekendDefinition;
import com.employee.scheduler.nurserostering.domain.pattern.WorkBeforeFreeSequencePattern;
import com.employee.scheduler.nurserostering.domain.contract.BooleanContractLine;
...
import com.employee.scheduler.nurserostering.domain.contract.ContractLineType;
import com.employee.scheduler.nurserostering.domain.contract.MinMaxContractLine;
